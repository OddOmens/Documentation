...
prev:
  text: 'Overview'
  link: '/Products/Depthful/Overview'
next: false
title: Depthful - Version History
---

# Depthful Version History

::: warning
This version history log is maintained by the product development team. For questions about specific versions or features, please view the feature and issue page or contact the support team.
:::
...
- **Release Notes:**
    - Added "Afternoon" to Odd Omens list
...
- **Release Date:** Released with 2.1.0
- **Release Notes:**
...
- **Release Notes:**
    ...
    - Adjusted size of tags in Select Tag view
...
- **Release Notes:**
    ...
    - Fixed Apps by Odd Omens section
...
- **Release Notes:**
    ...
    - Updated "Apps by Odd Omens" Section
...
- **Release Notes:**
    - The Initial Release of Depthful, a mind companion app to make your thoughts more organized and streamlined